...
/******************************************************************************
                            1:修改产品信息                
******************************************************************************/
#define PRODUCT_KEY "IOwDerbbvVoJ7qUI"    //开发平台创建产品后生成的16位字符产品唯一标识
...
#define DPID_PM25 2
//模式(可下发可上报)
//备注:手动模式；自动模式；舒适模式；睡眠模式。可根据产品实际功能进行修改。
#define DPID_MODE 3
//风速(可下发可上报)
//备注:
#define DPID_SPEED 4
...
//优(只上报)
//备注:优，良，中，差，极差，超级差
#define DPID_AIR_QUALITY_INDOOR 101
//室外空气质量(只下发)
//备注:
#define DPID_AIR_QUALITY_OUTDOOR 102
//室外PM2.5(只下发)
//备注:
#define DPID_PM25_OUTDOOR 103
//睡眠(可下发可上报)
//备注:
#define DPID_SLEEP 104
